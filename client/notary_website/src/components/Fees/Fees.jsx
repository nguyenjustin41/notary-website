...
const Fees = () => {
    let url = "http://localhost:5000/fees"
    // populates the select tag for the fees form
    ...
    const calculateDistance = async (url) => {
      axios.post(url, {
        ...
        console.log(`miles calculated ${response.data}`)
    ...
    const handleSubmit = (event) => { 
        ...
        // point system to determine what the total estimate will be
        ...
        if (selectedMortgage) {
          ...
          if (selectedMortgage === SINGLEPAGE) {
            ...
            totalPoints += 2
            console.log("+2 points added for Other Packages (besides the single page, misc, & reverse)")
          }
        }
        ...
        // if single page doc is selected reset the points back to 0 
        // => $75 - $100 estimate
                    ...
                    <label className="flex flex-col items-start justify-start font-semibold text-[20px]">Enter Appointment Address:</label>
                      <input 
                        ...
                        {   
                            ...
                            mortgageOptions.map((mortgage, index) => <option value={index} name={mortgage}>{mortgage}</option>)
                        }
                        </select>
                  ...
                  <div className="flex flex-col items-center justify-center bg-white rounded-[10px] w-[100%] h-[100%] px-[5%] py-[2%] gap-y-[10px] shadow-lg">
                    ...
                    <form className="w-[100%]">
                      ...
                      <div className="w-[100%] h-[100%]">
                          ...
                          <div className="flex flex-row justify-around items-center w-[100%] bg-gray-300">
                          ...
                          <div className="flex flex-row justify-around items-center w-[100%]">
                            ...
                            <h2 className="text-[20px]">Approx Distance (Miles): </h2>
                            <h2 className="text-[20px]">

                              {distanceMiles === 0 ? "less than 5" : 
                                `${distanceMiles}`
                              }
                          ...
                          <div className="flex flex-row items-between justify-around gap-x-[5%] px-[5%] py-[2%]">
                            ...
                            <button className="flex flex-row justify-center items-center w-[100%] shadow-lg rounded-[10px] font-semibold text-[16px] text-white outline-hidden cursor-pointer transition-all ease-in-out duration-200 bg-button-color whitespace-nowrap p-[10px] text-shadow hover:bg-button-color-hover">Contact</button>
