...
import { FaBell, FaDollarSign, FaShippingFast, FaHeadSideMask, FaHome, FaRoute, FaHandshake } from 'react-icons/fa'
...
const Process = () => {
  ...
  return (
    ...
    <div id="process" className="flex flex-col relative justify-start items-center bg-button-color h-[100%] py-[5%] md:mt-[0%]">
        ...
        <VerticalTimeline>
            {timelineElements.map((element) => {
                ...
                let isDollarIcon = element.icon === "dollar" 
                let isDocument = element.icon === "document"
                let isMask = element.icon === "mask"
                let isHome = element.icon === "home"
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex flex-row justify-center items-center mt-[2%]">
                            ...
                            <button className="flex flex-row justify-center py-[2%] rounded-[5px] w-[100%] shadow-lg text-[23px] text-white outline-hidden cursor-pointer transition-all ease-in-out duration-200 bg-button-color whitespace-nowrap text-shadow md:hover:bg-button-color-hover" onClick={()=> window.open("/fees")}>Get a Quote</button> 
                        </div> : ""}
